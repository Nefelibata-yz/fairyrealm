...
// .wrangler/tmp/bundle-eso4ig/checked-fetch.js
...
`;
function assemblePrompt(bookContext, userHistory, userMessage) {
  return `
${SYSTEM_PROMPT}
...
__name(assemblePrompt, "assemblePrompt");
...
async function getConversationHistory(db, conversationId) {
  ...
  return results.map((m) => ({
    ...
    feedback: m.feedback_json ? JSON.parse(m.feedback_json) : void 0
  }));
}
...
// .wrangler/tmp/bundle-eso4ig/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-eso4ig/middleware-loader.entry.ts
